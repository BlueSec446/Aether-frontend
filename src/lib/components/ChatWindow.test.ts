...
describe('ChatWindow Component', () => {
    ...
    it('renders incoming and outgoing messages correctly', () => {
        const mockMessages: Message[] = [
            { id: 1, chat_id: 1, sender_contact_id: null, content: 'Hello from me', timestamp: '2023-01-01T10:00:00Z', status: 'OUTGOING_RECEIVED' },
            { id: 2, chat_id: 1, sender_contact_id: 99, content: 'Hello from contact', timestamp: '2023-01-01T10:01:00Z', status: 'INCOMING_READ' }
        ];
